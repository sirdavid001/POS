...
export async function renderSettings() {
  ...
  content.innerHTML = `
    <div class="animate-fade-in">
      ...
      <section class="glass-card settings-legal-card">
        <div class="settings-legal-copy">
          <span class="settings-legal-kicker">Legal &amp; Privacy</span>
          <h3>Know the terms behind your store account</h3>
      ...
      <div class="modal" style="max-width:420px;">
        ...
        <form id="edit-staff-form">
          ...
          <div class="form-group">
            ...
            <input class="input" type="password" name="password" placeholder="Leave blank to keep current password" minlength="8">
      ...
      <div class="modal" style="max-width:420px;">
        ...
        <form id="staff-form">
          ...
          <div class="form-group">
            ...
            <input class="input" type="password" name="password" placeholder="Set initial password" minlength="8" required>
          </div>
          <div class="form-group">
